...
@Component
public class AlertDescriptorSupplier extends DatabaseOperation {

	public Mono<List<AlertDescriptor>> getAllAlertDescriptors(){
		
		CompletableFuture<List<AlertDescriptor>> itemFuture = client.query(builder->{
			...
			builder.expressionAttributeValues(Map.of(":pk", AttributeValue.builder()
					...
					AttributeValue.builder()
						.s(SortKeySearchConstants.INDICATOR_DISCRIPTOR_ALERTS.getSearchConstant())
						.build()
					));
